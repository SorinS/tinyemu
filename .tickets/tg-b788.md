...
---
# Review batch 057: slirp.c (7 functions, 292 lines)

Review C code batch 57 and ensure Go implementation matches exactly.

## C Functions to Review

- `get_dns_addr` (tinyemu-2019-12-21/slirp/slirp.c:48-91, 44 lines)
- `winsock_cleanup` (tinyemu-2019-12-21/slirp/slirp.c:93-96, 4 lines)
- `get_dns_addr` (tinyemu-2019-12-21/slirp/slirp.c:102-165, 64 lines)
- `slirp_init_once` (tinyemu-2019-12-21/slirp/slirp.c:169-187, 19 lines)
- `slirp_init` (tinyemu-2019-12-21/slirp/slirp.c:189-226, 38 lines)
- `slirp_cleanup` (tinyemu-2019-12-21/slirp/slirp.c:228-233, 6 lines)
- `slirp_select_fill` (tinyemu-2019-12-21/slirp/slirp.c:239-355, 117 lines)
...
5. **If Go code exists:**
   ...
   - Add/update comments referencing C code: `// Reference: tinyemu-2019-12-21/slirp/slirp.c:48-355`
