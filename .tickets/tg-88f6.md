...
---
# Review batch 058: slirp.c (3 functions, 269 lines)

Review C code batch 58 and ensure Go implementation matches exactly.

## C Functions to Review

- `slirp_select_poll` (tinyemu-2019-12-21/slirp/slirp.c:357-535, 179 lines)
- `arp_input` (tinyemu-2019-12-21/slirp/slirp.c:570-626, 57 lines)
- `slirp_input` (tinyemu-2019-12-21/slirp/slirp.c:628-660, 33 lines)
...
5. **If Go code exists:**
   ...
   - Add/update comments referencing C code: `// Reference: tinyemu-2019-12-21/slirp/slirp.c:357-660`
