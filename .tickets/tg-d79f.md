...
---
# Review batch 036: riscv_cpu.c (8 functions, 295 lines)

Review C code batch 36 and ensure Go implementation matches exactly.

## C Functions to Review

- `target_read_slow` (tinyemu-2019-12-21/riscv_cpu.c:297-436, 140 lines)
- `target_write_slow` (tinyemu-2019-12-21/riscv_cpu.c:439-522, 84 lines)
- `get_insn32` (tinyemu-2019-12-21/riscv_cpu.c:529-536, 8 lines)
- `target_read_insn_slow` (tinyemu-2019-12-21/riscv_cpu.c:539-566, 28 lines)
- `target_read_insn_u16` (tinyemu-2019-12-21/riscv_cpu.c:569-585, 17 lines)
- `tlb_init` (tinyemu-2019-12-21/riscv_cpu.c:587-596, 10 lines)
- `tlb_flush_all` (tinyemu-2019-12-21/riscv_cpu.c:598-601, 4 lines)
- `tlb_flush_vaddr` (tinyemu-2019-12-21/riscv_cpu.c:603-606, 4 lines)
...
5. **If Go code exists:**
   ...
   - Add/update comments referencing C code: `// Reference: tinyemu-2019-12-21/riscv_cpu.c:297-606`
