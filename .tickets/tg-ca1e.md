...
---
# Review batch 013: fs_net.c (9 functions, 281 lines)

Review C code batch 13 and ensure Go implementation matches exactly.

## C Functions to Review

- `fs_readdir` (tinyemu-2019-12-21/fs_net.c:1107-1160, 54 lines)
- `fs_read` (tinyemu-2019-12-21/fs_net.c:1162-1183, 22 lines)
- `fs_truncate` (tinyemu-2019-12-21/fs_net.c:1185-1244, 60 lines)
- `fs_write` (tinyemu-2019-12-21/fs_net.c:1246-1281, 36 lines)
- `fs_close` (tinyemu-2019-12-21/fs_net.c:1283-1290, 8 lines)
- `fs_stat` (tinyemu-2019-12-21/fs_net.c:1292-1329, 38 lines)
- `fs_setattr` (tinyemu-2019-12-21/fs_net.c:1331-1368, 38 lines)
- `fs_link` (tinyemu-2019-12-21/fs_net.c:1370-1380, 11 lines)
- `fs_symlink` (tinyemu-2019-12-21/fs_net.c:1382-1395, 14 lines)
...
5. **If Go code exists:**
   ...
   - Add/update comments referencing C code: `// Reference: tinyemu-2019-12-21/fs_net.c:1107-1395`
