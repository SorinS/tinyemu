...
---
# Review batch 065: tcp_output.c (1 functions, 422 lines)

Review C code batch 65 and ensure Go implementation matches exactly.

## C Functions to Review

- `tcp_output` (tinyemu-2019-12-21/slirp/tcp_output.c:56-477, 422 lines)
...
5. **If Go code exists:**
   ...
   - Add/update comments referencing C code: `// Reference: tinyemu-2019-12-21/slirp/tcp_output.c:56-477`
