...
---
# Review batch 083: virtio.c (6 functions, 275 lines)

Review C code batch 83 and ensure Go implementation matches exactly.

## C Functions to Review

- `virtio_mmio_read` (tinyemu-2019-12-21/virtio.c:606-700, 95 lines)
- `set_low32` (tinyemu-2019-12-21/virtio.c:703-706, 4 lines)
- `set_high32` (tinyemu-2019-12-21/virtio.c:708-711, 4 lines)
- `set_low32` (tinyemu-2019-12-21/virtio.c:713-716, 4 lines)
- `virtio_mmio_write` (tinyemu-2019-12-21/virtio.c:719-793, 75 lines)
- `virtio_pci_read` (tinyemu-2019-12-21/virtio.c:795-887, 93 lines)
...
5. **If Go code exists:**
   ...
   - Add/update comments referencing C code: `// Reference: tinyemu-2019-12-21/virtio.c:606-887`
