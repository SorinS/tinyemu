...
---
# Review batch 064: tcp_input.c (4 functions, 159 lines)

Review C code batch 64 and ensure Go implementation matches exactly.

## C Functions to Review

- `tcp_dooptions` (tinyemu-2019-12-21/slirp/tcp_input.c:1290-1325, 36 lines)
- `tcp_pulloutofband` (tinyemu-2019-12-21/slirp/tcp_input.c:1338-1362, 25 lines)
- `tcp_xmit_timer` (tinyemu-2019-12-21/slirp/tcp_input.c:1372-1440, 69 lines)
- `tcp_mss` (tinyemu-2019-12-21/slirp/tcp_input.c:1459-1487, 29 lines)
...
5. **If Go code exists:**
   ...
   - Add/update comments referencing C code: `// Reference: tinyemu-2019-12-21/slirp/tcp_input.c:1290-1487`
