...
---
# Review batch 053: ip_input.c (2 functions, 201 lines)

Review C code batch 53 and ensure Go implementation matches exactly.

## C Functions to Review

- `ip_dooptions` (tinyemu-2019-12-21/slirp/ip_input.c:474-659, 186 lines)
- `ip_stripoptions` (tinyemu-2019-12-21/slirp/ip_input.c:671-685, 15 lines)
...
5. **If Go code exists:**
   ...
   - Add/update comments referencing C code: `// Reference: tinyemu-2019-12-21/slirp/ip_input.c:474-685`
