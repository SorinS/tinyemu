...
---
# Review batch 002: aes.c (1 functions, 186 lines)

Review C code batch 2 and ensure Go implementation matches exactly.

## C Functions to Review

- `AES_encrypt` (tinyemu-2019-12-21/aes.c:892-1077, 186 lines)
...
5. **If Go code exists:**
   ...
   - Add/update comments referencing C code: `// Reference: tinyemu-2019-12-21/aes.c:892-1077`
