...
---
# Review batch 095: x86_machine.c (6 functions, 191 lines)

Review C code batch 95 and ensure Go implementation matches exactly.

## C Functions to Review

- `kvm_exit_io` (tinyemu-2019-12-21/x86_machine.c:1754-1794, 41 lines)
- `kvm_exit_mmio` (tinyemu-2019-12-21/x86_machine.c:1796-1868, 73 lines)
- `kvm_exec` (tinyemu-2019-12-21/x86_machine.c:1870-1925, 56 lines)
- `cpu_get_tsc` (tinyemu-2019-12-21/x86_machine.c:1932-1938, 7 lines)
- `cpu_get_tsc` (tinyemu-2019-12-21/x86_machine.c:1943-1950, 8 lines)
- `pc_flush_tlb_write_range` (tinyemu-2019-12-21/x86_machine.c:1953-1958, 6 lines)
...
5. **If Go code exists:**
   ...
   - Add/update comments referencing C code: `// Reference: tinyemu-2019-12-21/x86_machine.c:1754-1958`
