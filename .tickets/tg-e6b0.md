...
---
# Review batch 005: block_net.c (2 functions, 127 lines)

Review C code batch 5 and ensure Go implementation matches exactly.

## C Functions to Review

- `block_device_init_http` (tinyemu-2019-12-21/block_net.c:404-437, 34 lines)
- `bf_init_onload` (tinyemu-2019-12-21/block_net.c:439-531, 93 lines)
...
5. **If Go code exists:**
   ...
   - Add/update comments referencing C code: `// Reference: tinyemu-2019-12-21/block_net.c:404-531`
