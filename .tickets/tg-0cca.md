...
---
# Review batch 016: fs_net.c (9 functions, 242 lines)

Review C code batch 16 and ensure Go implementation matches exactly.

## C Functions to Review

- `filelist_load` (tinyemu-2019-12-21/fs_net.c:2028-2041, 14 lines)
- `fatal_error` (tinyemu-2019-12-21/fs_net.c:2046-2055, 10 lines)
- `fs_create_cmd` (tinyemu-2019-12-21/fs_net.c:2057-2069, 13 lines)
- `fs_net_init` (tinyemu-2019-12-21/fs_net.c:2098-2120, 23 lines)
- `fs_initial_sync` (tinyemu-2019-12-21/fs_net.c:2122-2151, 30 lines)
- `head_loaded` (tinyemu-2019-12-21/fs_net.c:2153-2197, 45 lines)
- `filelist_loaded` (tinyemu-2019-12-21/fs_net.c:2199-2219, 21 lines)
- `kernel_load_cb` (tinyemu-2019-12-21/fs_net.c:2229-2265, 37 lines)
- `preload_parse_str_old` (tinyemu-2019-12-21/fs_net.c:2267-2315, 49 lines)
...
5. **If Go code exists:**
   ...
   - Add/update comments referencing C code: `// Reference: tinyemu-2019-12-21/fs_net.c:2028-2315`
