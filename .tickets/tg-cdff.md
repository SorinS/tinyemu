...
---
# Review batch 051: ip_input.c (2 functions, 169 lines)

Review C code batch 51 and ensure Go implementation matches exactly.

## C Functions to Review

- `ip_init` (tinyemu-2019-12-21/slirp/ip_input.c:59-64, 6 lines)
- `ip_input` (tinyemu-2019-12-21/slirp/ip_input.c:71-233, 163 lines)
...
5. **If Go code exists:**
   ...
   - Add/update comments referencing C code: `// Reference: tinyemu-2019-12-21/slirp/ip_input.c:59-233`
