...
---
# Review batch 018: fs_net.c (12 functions, 274 lines)

Review C code batch 18 and ensure Go implementation matches exactly.

## C Functions to Review

- `fs_cmd_set_base_url` (tinyemu-2019-12-21/fs_net.c:2615-2660, 46 lines)
- `fs_cmd_reset_base_url` (tinyemu-2019-12-21/fs_net.c:2662-2672, 11 lines)
- `fs_cmd_set_url` (tinyemu-2019-12-21/fs_net.c:2674-2698, 25 lines)
- `fs_cmd_export_file` (tinyemu-2019-12-21/fs_net.c:2700-2729, 30 lines)
- `fs_cmd_pbkdf2` (tinyemu-2019-12-21/fs_net.c:2732-2766, 35 lines)
- `fs_cmd_set_import_dir` (tinyemu-2019-12-21/fs_net.c:2768-2778, 11 lines)
- `fs_cmd_write` (tinyemu-2019-12-21/fs_net.c:2780-2821, 42 lines)
- `fs_cmd_read` (tinyemu-2019-12-21/fs_net.c:2823-2835, 13 lines)
- `fs_cmd_close` (tinyemu-2019-12-21/fs_net.c:2837-2849, 13 lines)
- `fs_net_set_pwd` (tinyemu-2019-12-21/fs_net.c:2853-2865, 13 lines)
- `fs_import_file` (tinyemu-2019-12-21/fs_net.c:2871-2901, 31 lines)
- `fs_export_file` (tinyemu-2019-12-21/fs_net.c:2905-2908, 4 lines)
...
5. **If Go code exists:**
   ...
   - Add/update comments referencing C code: `// Reference: tinyemu-2019-12-21/fs_net.c:2615-2908`
