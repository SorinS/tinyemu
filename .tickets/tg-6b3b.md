...
---
# Review batch 001: aes.c (2 functions, 144 lines)

Review C code batch 1 and ensure Go implementation matches exactly.

## C Functions to Review

- `AES_set_encrypt_key` (tinyemu-2019-12-21/aes.c:738-834, 97 lines)
- `AES_set_decrypt_key` (tinyemu-2019-12-21/aes.c:839-885, 47 lines)
...
5. **If Go code exists:**
   ...
   - Add/update comments referencing C code: `// Reference: tinyemu-2019-12-21/aes.c:738-885`
