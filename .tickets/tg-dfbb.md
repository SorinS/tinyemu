...
---
# Review batch 041: riscv_cpu_template.h (1 functions, 1535 lines)

Review C code batch 41 and ensure Go implementation matches exactly.

## C Functions to Review

- `glue` (tinyemu-2019-12-21/riscv_cpu_template.h:200-1734, 1535 lines)
...
5. **If Go code exists:**
   ...
   - Add/update comments referencing C code: `// Reference: tinyemu-2019-12-21/riscv_cpu_template.h:200-1734`
