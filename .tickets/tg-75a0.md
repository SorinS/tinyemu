...
deps: []
links: []
created: 2026-01-23T18:25:51Z
type: task
priority: 2
assignee: JT Olio
tags: [c-review, port-verification]
---
# Review batch 097: x86_machine.c (3 functions, 212 lines)

Review C code batch 97 and ensure Go implementation matches exactly.

## C Functions to Review

- `copy_kernel` (tinyemu-2019-12-21/x86_machine.c:2343-2523, 181 lines)
- `pc_machine_get_sleep_duration` (tinyemu-2019-12-21/x86_machine.c:2526-2544, 19 lines)
- `pc_machine_interp` (tinyemu-2019-12-21/x86_machine.c:2546-2557, 12 lines)
...
5. **If Go code exists:**
   ...
   - Add/update comments referencing C code: `// Reference: tinyemu-2019-12-21/x86_machine.c:2343-2557`
