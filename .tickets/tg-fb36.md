...
---
# Review batch 061: socket.c (4 functions, 296 lines)

Review C code batch 61 and ensure Go implementation matches exactly.

## C Functions to Review

- `sowrite` (tinyemu-2019-12-21/slirp/socket.c:339-425, 87 lines)
- `sorecvfrom` (tinyemu-2019-12-21/slirp/socket.c:431-526, 96 lines)
- `sosendto` (tinyemu-2019-12-21/slirp/socket.c:532-573, 42 lines)
- `tcp_listen` (tinyemu-2019-12-21/slirp/socket.c:579-649, 71 lines)
...
5. **If Go code exists:**
   ...
   - Add/update comments referencing C code: `// Reference: tinyemu-2019-12-21/slirp/socket.c:339-649`
