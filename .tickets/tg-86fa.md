...
---
# Review batch 034: ps2.c (4 functions, 153 lines)

Review C code batch 34 and ensure Go implementation matches exactly.

## C Functions to Review

- `ps2_write_mouse` (tinyemu-2019-12-21/ps2.c:334-458, 125 lines)
- `ps2_reset` (tinyemu-2019-12-21/ps2.c:460-469, 10 lines)
- `ps2_kbd_init` (tinyemu-2019-12-21/ps2.c:471-479, 9 lines)
- `ps2_mouse_init` (tinyemu-2019-12-21/ps2.c:481-489, 9 lines)
...
5. **If Go code exists:**
   ...
   - Add/update comments referencing C code: `// Reference: tinyemu-2019-12-21/ps2.c:334-489`
