...
---
# Review batch 029: machine.c (8 functions, 289 lines)

Review C code batch 29 and ensure Go implementation matches exactly.

## C Functions to Review

- `virt_machine_parse_config` (tinyemu-2019-12-21/machine.c:223-404, 182 lines)
- `get_file_path` (tinyemu-2019-12-21/machine.c:424-446, 23 lines)
- `load_file` (tinyemu-2019-12-21/machine.c:450-453, 4 lines)
- `load_file` (tinyemu-2019-12-21/machine.c:456-478, 23 lines)
- `config_load_file_cb` (tinyemu-2019-12-21/machine.c:482-492, 11 lines)
- `config_load_file` (tinyemu-2019-12-21/machine.c:495-513, 19 lines)
- `virt_machine_load_config_file` (tinyemu-2019-12-21/machine.c:515-529, 15 lines)
- `config_file_loaded` (tinyemu-2019-12-21/machine.c:531-542, 12 lines)
...
5. **If Go code exists:**
   ...
   - Add/update comments referencing C code: `// Reference: tinyemu-2019-12-21/machine.c:223-542`
