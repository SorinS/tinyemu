...
---
# Review batch 077: temu.c (11 functions, 190 lines)

Review C code batch 77 and ensure Go implementation matches exactly.

## C Functions to Review

- `tun_open` (tinyemu-2019-12-21/temu.c:414-451, 38 lines)
- `slirp_write_packet` (tinyemu-2019-12-21/temu.c:462-467, 6 lines)
- `slirp_can_output` (tinyemu-2019-12-21/temu.c:469-473, 5 lines)
- `slirp_output` (tinyemu-2019-12-21/temu.c:475-479, 5 lines)
- `slirp_select_fill1` (tinyemu-2019-12-21/temu.c:481-487, 7 lines)
- `slirp_select_poll1` (tinyemu-2019-12-21/temu.c:489-495, 7 lines)
- `slirp_open` (tinyemu-2019-12-21/temu.c:497-530, 34 lines)
- `virt_machine_run` (tinyemu-2019-12-21/temu.c:537-600, 64 lines)
- `help` (tinyemu-2019-12-21/temu.c:615-630, 16 lines)
- `net_start_cb` (tinyemu-2019-12-21/temu.c:635-638, 4 lines)
- `net_poll_cb` (tinyemu-2019-12-21/temu.c:640-643, 4 lines)
...
5. **If Go code exists:**
   ...
   - Add/update comments referencing C code: `// Reference: tinyemu-2019-12-21/temu.c:414-643`
