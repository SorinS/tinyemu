...
---
# Review batch 062: socket.c + 1 more (6 functions, 158 lines)

Review C code batch 62 and ensure Go implementation matches exactly.

## C Functions to Review

- `soisfconnecting` (tinyemu-2019-12-21/slirp/socket.c:658-663, 6 lines)
- `soisfconnected` (tinyemu-2019-12-21/slirp/socket.c:666-670, 5 lines)
- `sofcantrcvmore` (tinyemu-2019-12-21/slirp/socket.c:673-688, 16 lines)
- `sofcantsendmore` (tinyemu-2019-12-21/slirp/socket.c:691-709, 19 lines)
- `sofwdrain` (tinyemu-2019-12-21/slirp/socket.c:716-722, 7 lines)
- `tcp_reass` (tinyemu-2019-12-21/slirp/tcp_input.c:105-209, 105 lines)
...
5. **If Go code exists:**
   ...
   - Add/update comments referencing C code: `// Reference: tinyemu-2019-12-21/slirp/socket.c:658-209`
