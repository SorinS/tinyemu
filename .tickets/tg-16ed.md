...
---
# Review batch 086: virtio.c (8 functions, 285 lines)

Review C code batch 86 and ensure Go implementation matches exactly.

## C Functions to Review

- `virtio_input_config_write` (tinyemu-2019-12-21/virtio.c:1516-1630, 115 lines)
- `virtio_input_init` (tinyemu-2019-12-21/virtio.c:1632-1644, 13 lines)
- `fid_find1` (tinyemu-2019-12-21/virtio.c:1663-1674, 12 lines)
- `fid_find` (tinyemu-2019-12-21/virtio.c:1676-1684, 9 lines)
- `fid_delete` (tinyemu-2019-12-21/virtio.c:1686-1696, 11 lines)
- `fid_set` (tinyemu-2019-12-21/virtio.c:1698-1712, 15 lines)
- `get_9p_op_name` (tinyemu-2019-12-21/virtio.c:1749-1757, 9 lines)
- `marshall` (tinyemu-2019-12-21/virtio.c:1761-1861, 101 lines)
...
5. **If Go code exists:**
   ...
   - Add/update comments referencing C code: `// Reference: tinyemu-2019-12-21/virtio.c:1516-1861`
