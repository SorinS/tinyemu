...
---
# Review batch 050: ip_icmp.c (3 functions, 257 lines)

Review C code batch 50 and ensure Go implementation matches exactly.

## C Functions to Review

- `icmp_input` (tinyemu-2019-12-21/slirp/ip_icmp.c:67-166, 100 lines)
- `icmp_error` (tinyemu-2019-12-21/slirp/ip_icmp.c:189-300, 112 lines)
- `icmp_reflect` (tinyemu-2019-12-21/slirp/ip_icmp.c:307-351, 45 lines)
...
5. **If Go code exists:**
   ...
   - Add/update comments referencing C code: `// Reference: tinyemu-2019-12-21/slirp/ip_icmp.c:67-351`
...
- `tinyemu-2019-12-21/slirp/ip_icmp.c`
