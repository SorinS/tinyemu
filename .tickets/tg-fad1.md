...
---
# Review batch 072: softfp_template.h (5 functions, 252 lines)

Review C code batch 72 and ensure Go implementation matches exactly.

## C Functions to Review

- `mul_u` (tinyemu-2019-12-21/softfp_template.h:320-343, 24 lines)
- `mul_sf` (tinyemu-2019-12-21/softfp_template.h:349-399, 51 lines)
- `fma_sf` (tinyemu-2019-12-21/softfp_template.h:402-552, 151 lines)
- `divrem_u` (tinyemu-2019-12-21/softfp_template.h:556-562, 7 lines)
- `divrem_u` (tinyemu-2019-12-21/softfp_template.h:567-585, 19 lines)
...
5. **If Go code exists:**
   ...
   - Add/update comments referencing C code: `// Reference: tinyemu-2019-12-21/softfp_template.h:320-585`
