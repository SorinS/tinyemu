...
---
# Review batch 017: fs_net.c (5 functions, 277 lines)

Review C code batch 17 and ensure Go implementation matches exactly.

## C Functions to Review

- `preload_parse_str` (tinyemu-2019-12-21/fs_net.c:2317-2412, 96 lines)
- `preload_parse` (tinyemu-2019-12-21/fs_net.c:2414-2434, 21 lines)
- `parse_hex_buf` (tinyemu-2019-12-21/fs_net.c:2452-2468, 17 lines)
- `fs_cmd_xhr` (tinyemu-2019-12-21/fs_net.c:2470-2584, 115 lines)
- `fs_cmd_xhr_on_load` (tinyemu-2019-12-21/fs_net.c:2586-2613, 28 lines)
...
5. **If Go code exists:**
   ...
   - Add/update comments referencing C code: `// Reference: tinyemu-2019-12-21/fs_net.c:2317-2613`
