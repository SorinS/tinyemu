...
---
# Review batch 035: riscv_cpu.c (9 functions, 172 lines)

Review C code batch 35 and ensure Go implementation matches exactly.

## C Functions to Review

- `log_vprintf` (tinyemu-2019-12-21/riscv_cpu.c:69-74, 6 lines)
- `log_vprintf` (tinyemu-2019-12-21/riscv_cpu.c:76-79, 4 lines)
- `log_printf` (tinyemu-2019-12-21/riscv_cpu.c:82-88, 7 lines)
- `fprint_target_ulong` (tinyemu-2019-12-21/riscv_cpu.c:91-94, 4 lines)
- `fprint_target_ulong` (tinyemu-2019-12-21/riscv_cpu.c:96-99, 4 lines)
- `print_target_ulong` (tinyemu-2019-12-21/riscv_cpu.c:102-105, 4 lines)
- `dump_regs` (tinyemu-2019-12-21/riscv_cpu.c:114-144, 31 lines)
- `cpu_abort` (tinyemu-2019-12-21/riscv_cpu.c:146-150, 5 lines)
- `get_phys_addr` (tinyemu-2019-12-21/riscv_cpu.c:188-294, 107 lines)
...
5. **If Go code exists:**
   ...
   - Add/update comments referencing C code: `// Reference: tinyemu-2019-12-21/riscv_cpu.c:69-294`
