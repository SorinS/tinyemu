...
---
# Review batch 052: ip_input.c (5 functions, 194 lines)

Review C code batch 52 and ensure Go implementation matches exactly.

## C Functions to Review

- `ip_reass` (tinyemu-2019-12-21/slirp/ip_input.c:244-392, 149 lines)
- `ip_freef` (tinyemu-2019-12-21/slirp/ip_input.c:399-410, 12 lines)
- `ip_enq` (tinyemu-2019-12-21/slirp/ip_input.c:417-425, 9 lines)
- `ip_deq` (tinyemu-2019-12-21/slirp/ip_input.c:431-435, 5 lines)
- `ip_slowtimo` (tinyemu-2019-12-21/slirp/ip_input.c:443-461, 19 lines)
...
5. **If Go code exists:**
   ...
   - Add/update comments referencing C code: `// Reference: tinyemu-2019-12-21/slirp/ip_input.c:244-461`
...
- `tinyemu-2019-12-21/slirp/ip_input.c`
