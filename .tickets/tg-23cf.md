...
---
# Review batch 087: virtio.c (5 functions, 165 lines)

Review C code batch 87 and ensure Go implementation matches exactly.

## C Functions to Review

- `unmarshall` (tinyemu-2019-12-21/virtio.c:1865-1965, 101 lines)
- `virtio_9p_send_reply` (tinyemu-2019-12-21/virtio.c:1967-1990, 24 lines)
- `virtio_9p_send_error` (tinyemu-2019-12-21/virtio.c:1992-2000, 9 lines)
- `virtio_9p_open_reply` (tinyemu-2019-12-21/virtio.c:2009-2025, 17 lines)
- `virtio_9p_open_cb` (tinyemu-2019-12-21/virtio.c:2027-2040, 14 lines)
...
5. **If Go code exists:**
   ...
   - Add/update comments referencing C code: `// Reference: tinyemu-2019-12-21/virtio.c:1865-2040`
