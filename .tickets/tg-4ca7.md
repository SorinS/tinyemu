...
---
# Review batch 003: aes.c (2 functions, 236 lines)

Review C code batch 3 and ensure Go implementation matches exactly.

## C Functions to Review

- `AES_decrypt` (tinyemu-2019-12-21/aes.c:1083-1268, 186 lines)
- `AES_cbc_encrypt` (tinyemu-2019-12-21/aes.c:1272-1321, 50 lines)
...
5. **If Go code exists:**
   ...
   - Add/update comments referencing C code: `// Reference: tinyemu-2019-12-21/aes.c:1083-1321`
