...
---
# Review batch 046: sha256.c (6 functions, 218 lines)

Review C code batch 46 and ensure Go implementation matches exactly.

## C Functions to Review

- `sha256_compress` (tinyemu-2019-12-21/sha256.c:60-176, 117 lines)
- `sha256_compress` (tinyemu-2019-12-21/sha256.c:179-185, 7 lines)
- `SHA256_Init` (tinyemu-2019-12-21/sha256.c:193-205, 13 lines)
- `SHA256_Update` (tinyemu-2019-12-21/sha256.c:207-235, 29 lines)
- `SHA256_Final` (tinyemu-2019-12-21/sha256.c:243-286, 44 lines)
- `SHA256` (tinyemu-2019-12-21/sha256.c:288-295, 8 lines)
...
5. **If Go code exists:**
   ...
   - Add/update comments referencing C code: `// Reference: tinyemu-2019-12-21/sha256.c:60-295`
