...
#
# After the page-cross fix + FCOMPP operand-order fix, awk reads files
# correctly, `setup_inittab_console` and openrc's `modloop` no longer
# hang, and Alpine boots end-to-end to `localhost login:` on /dev/ttyS0.
